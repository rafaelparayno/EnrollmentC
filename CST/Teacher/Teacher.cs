...
namespace CST
{
    public partial class Teacher : Form
    {
        ...
        public Teacher(string MyLabelText, string hi)
        {
            InitializeComponent();
        ...
        private void btnEnroll_Click(object sender, EventArgs e)
        {
                ...
                this.Hide();
                TeacherSchedule fr1 = new TeacherSchedule(label5.Text,label1.Text,label6.Text);
                fr1.ShowDialog();
                return;
        ...
        {
            this.Hide();
      ListofSection fr1 = new ListofSection (label5.Text, label1.Text, label6.Text);
            fr1.ShowDialog();
            return;
        }
        ...
        {
            this.Hide();
            StudentGrades fr1 = new StudentGrades(label5.Text, label1.Text, label6.Text);
            fr1.ShowDialog();
        }
